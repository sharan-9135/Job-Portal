...
function Profile() {
    ...
    useGetAppliedJobs();
    const { user } = useSelector(store => store.auth); // Corrected
    const isResume = !!user?.profile?.resume; // Dynamically checking if resume exists
    ...
    return (
        <div>
            ...
            <div className='max-w-4xl mx-auto bg-white rounded-full'>
                <h1>Applied Jobs</h1>
                <AppliedJobTable />
            </div>
